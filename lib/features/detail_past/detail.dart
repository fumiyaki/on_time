  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [timeline(), Text("A")],
      ),
    );
  }
}

class timelinePageShow extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class _timelineState extends State<timeline> {
  ...
  Widget build(BuildContext context) {
      ...
      child: Timeline.tileBuilder(
          ...
          builder: TimelineTileBuilder.connected(
            ...
            contentsBuilder: (context, index) {
              ...
              if (index < 1) {
                return Timeline_Right(
                    litems, Color.fromRGBO(112, 112, 112, .53));
              } else {
                        ...
                        child: Card(
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(40, 0, 16, 4),
                                child: Text('プレゼン一組目',
                                    style: TextStyle(
    ...
    // otherPage(date, lis,litems, _value,_handleCheckbox)
    //   ],
    //  );
  }
}
...
class otherPage extends StatelessWidget {
  ...
  var _handleCheckbox;
  otherPage(
      this.date, this.lis, this.litems, this._value, this._handleCheckbox);
  @override
  Widget build(BuildContext context) {
